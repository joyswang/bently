...
public class MyTest {
    ...
    public void testHttps() {
        ...
        HttpConnectionCommon hcc =
                new HttpConnectionCommon("https://api.wx.qq.com/cgi-bin/token?grant_type=client_credential&appid=wxff3d1c1de2bd91fe&secret=adf7f3377400add0b0b4698af5a1fc58", "GET") ;
